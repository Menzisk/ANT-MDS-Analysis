# Cα-RMSD plots for AbANT and SaANT MD simulations
...
def plot_rmsd(df, systems, labels, outfile, legend_loc="lower left"):
...
plot_rmsd(df,
    ...
    outfile="AbANT_RMSD_Pos.controls.png",
...
plot_rmsd(df,
    ...
    outfile="SaANT_RMSD_Pos.controls.png",
    legend_loc="lower left"
)
